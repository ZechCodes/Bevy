...
class ProviderBuilder(Generic[ProviderType]):
    ...
    def bind(self, context: bc.BaseContext) -> ProviderBuilder[ProviderType]:
        return ProviderBuilder(self._bind(context), *self.args, **self.kwargs)

    def _bind(
        self,
        context: bc.BaseContext
    ) -> ProviderType:
    ...
    def _create_bound_provider_type(self, context: bc.BaseContext) -> ProviderType:
        return cast(
            ProviderType,
            type(
